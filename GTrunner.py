...
def main(argv):
    ...
    parser.add_argument("-b", help="Value of b (unpaired nucleotide parameter)", type=float, default=0.4)
    parser.add_argument("-c", help="Value of c (branching helix parameter)", type=float, default=0.0)
