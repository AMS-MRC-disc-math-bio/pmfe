...
for vector in itertools.product([-1, 0, 1], repeat=4):
    ...
    ### The .as_fractions() method gets the result as a list of instances of Python's Fraction, a numeric type.
    ### A .as_rationals() method is also available which gives instances of Sage's Rational class instead.
