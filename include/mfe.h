...
namespace pmfe{
    ...
    RNAStructureWithScore mfe(fs::path seq_file, ParameterVector params, dangle_mode dangles = BOTH_DANGLE);
    RNAStructureWithScore mfe(fs::path seq_file, dangle_mode dangles = BOTH_DANGLE);
